...
public:
  ...
  void load (glgrib_field_float_buffer_ptr *, const std::vector<std::string> &, const glgrib_options_geometry &, float, glGribFieldMetadata *, int = 1, int = 0, bool diff = false);
  void load (glgrib_field_float_buffer_ptr *, const std::string &, const glgrib_options_geometry &, glGribFieldMetadata *);
