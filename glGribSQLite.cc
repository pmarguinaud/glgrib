...
void glgrib_sqlite_detail::iset (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, const long int * t) 
{
  ok (db, sqlite3_bind_int (req->data, 1 + rank, *t));
}

void glgrib_sqlite_detail::iset (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, const int * t) 
{
  ok (db, sqlite3_bind_int (req->data, 1 + rank, *t));
}

void glgrib_sqlite_detail::iset (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, const float * t) 
{
...
void glgrib_sqlite_detail::oget (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, float * t)
{
  *t = sqlite3_column_double (req->data, rank);
}

void glgrib_sqlite_detail::oget (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, char * t)
{
  const char * str = (const char *)sqlite3_column_text (req->data, rank);
  strcpy (t, str);
}

void glgrib_sqlite_detail::oget (sqlite3_ptr db, sqlite3_stmt_ptr req, int rank, std::string * t)
{
  const char * str = (const char *)sqlite3_column_text (req->data, rank);
  t->clear ();
