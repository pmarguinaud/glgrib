...
void glGrib::ShellBase::do_close (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
  gwindow->shouldClose ();
}

void glGrib::ShellBase::do_snapshot (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
   gwindow->framebuffer ();
}

void glGrib::ShellBase::do_sleep (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
  unlock ();
...
void glGrib::ShellBase::do_clone (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
  gwindow->setCloned ();
}

void glGrib::ShellBase::do_set (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
  int argc = args.size ();
...
void glGrib::ShellBase::do_window_select (const std::vector<std::string> & args, glGrib::Window * gwindow)
{
  try
    {
