...
public:
  ...
  virtual float resolution (int level = 0) const override { if (level == 0) level = Nj; return M_PI / level; }
  virtual void getTriangleNeighbours (int, int [3], int [3], glm::vec3 xyz[3]) const override;
