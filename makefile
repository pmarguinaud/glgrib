...
glgrib.x: glgrib_geometry.o glgrib_geometry_gaussian.o glgrib_window.o glgrib_options.o glgrib_shell.o glgrib_bmp.o glgrib_landscape_tex.o glgrib_palette.o glgrib_field.o glgrib_landscape.o glgrib_coords_world.o glgrib_coords.o glgrib_load.o glgrib_polygon.o glgrib_program.o glgrib_view.o glgrib_polyhedron.o glgrib.o glgrib_opengl.o glgrib_png.o glgrib_fb.o glgrib_world.o glgrib_scene.o glgrib_coastlines.o glgrib_grid.o glgrib_x11.o glgrib_shader.o
	g++  $(CXXFLAGS) -o glgrib.x glgrib_geometry.o glgrib_geometry_gaussian.o glgrib_window.o glgrib_options.o glgrib_shell.o glgrib_bmp.o glgrib_landscape_tex.o glgrib_palette.o glgrib_field.o glgrib_landscape.o glgrib_coords_world.o glgrib_coords.o glgrib_load.o glgrib_polygon.o glgrib_view.o glgrib_program.o glgrib_polyhedron.o glgrib.o glgrib_opengl.o glgrib_png.o glgrib_fb.o glgrib_world.o glgrib_scene.o glgrib_coastlines.o glgrib_grid.o glgrib_x11.o  glgrib_shader.o $(LDFLAGS)
