...
test_colorbar:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --field[0].path testdata/t1198c2.2/N.grb  --field[0].scale 1.03   \
...
test_bw_debug:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --field[0].path testdata/t1198c2.2/N.grb  --field[0].scale 1.03 --window.debug.on

test_3l_t1198:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb \
...
test_3l_t1798:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1798/Z.grb \
...
test_offscreen:
	\rm -f snapshot*.png
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --window.offscreen.on  \
...
test_landscape_eurat01:
	$(RUNTEST) --landscape.on --landscape.geometry  testdata/eurat01/lfpw_0_0_0_pl_1000_t.grib2 --landscape.orography 0 --coast.on --grid.on

test_glob01:
	$(RUNTEST) --field[0].path testdata/glob01/lfpw_0_0_0_sfc_0_t.grib2 --field[0].scale 1.00  --field[0].palette.name cold_hot_temp --coast.on --grid.on


test_small:
	$(RUNTEST) --landscape.on --landscape.geometry  testdata/t49/Z.grb  --field[0].scale 1.01  --field[0].path testdata/t49/SFX.CLAY.grb --coast.on --grid.on
...
test_missingvalue:
	$(RUNTEST) --field[0].path testdata/t49/SFX.CLAY.grb --coast.on --grid.on

test_aro:
	$(RUNTEST) --field[0].path testdata/aro2.5/SURFIND.TERREMER.grb --field[0].palette.name cold_hot --field[0].scale 1.00 --view.lat 46.2 --view.lon 2.0 --view.fov 5 --coast.on --grid.on

test_guyane:
	$(RUNTEST) --landscape.on --field\[0\].path testdata/aro_guyane/SURFTEMPERATURE.grb --field\[0\].palette.name cold_hot_temp --field\[0\].scale 1.01 --view.lat 5 --view.lon -51 --view.fov 3 --coast.on --grid.on

test_vector:
	$(RUNTEST) --field[0].vector.on --field\[0\].path testdata/aro2.5/S090WIND.U.PHYS.grb  testdata/aro2.5/S090WIND.V.PHYS.grb --field\[0\].scale 1.00 --field\[0\].vector.color green --view.lat 46.2 --view.lon 2.0 --view.fov 5  --coast.on --grid.on

test_small_aro:
	$(RUNTEST) --field[0].vector.on --field\[0\].path testdata/aro_small/S041WIND.U.PHYS.grb testdata/aro_small/S041WIND.V.PHYS.grb  --field\[0\].scale 1.00 --view.lon 26.64 --view.lat 67.36 --view.fov 0.5 --coast.on --grid.on

test_wind_arp:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t31c2.4/Z.grb --field[0].vector.on --field\[0\].path testdata/t31c2.4/S015WIND.U.PHYS.grb testdata/t31c2.4/S015WIND.V.PHYS.grb   --field[0].scale 1.01 --coast.on --grid.on

test_vector_glob25:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/arpt1798_wind/lfpw_0_2_2_sfc_20_u.grib2 --landscape.orography 0  --field[0].vector.on \
...
test_wind_t1798:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/arpt1798_wind/S105WIND.U.PHYS.grb --landscape.orography 0  --field[0].vector.on \
...
test_vector_t1798:
	$(RUNTEST)  --landscape.on --landscape.geometry testdata/arpt1798_wind/+1.grb --landscape.orography 0 --field[0].vector.on \
		--field\[0\].path testdata/arpt1798_wind/+1.grb testdata/arpt1798_wind/+1.grb  --field[0].scale 1.01 --coast.on --grid.on

test_contour1:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/t0049.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour2:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/t0479.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour3:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/t1798.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_stretched:
	$(RUNTEST) --window.width 1024 --window.height 1024 --field\[0\].path testdata/t1198c2.2/Z.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon1:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/latlon9x6.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon2:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/latlon18x13.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon3:
	$(RUNTEST) --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/eurat01/lfpw_0_0_0_pl_1000_t.grib2 --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon4:
	$(RUNTEST) --window.width 1024 --window.height 1024 --field\[0\].path testdata/glob025/lfpw_0_0_0_pl_1000_t.grib2 --field\[1\].path testdata/glob025/lfpw_0_0_0_pl_1000_t.grib2 --field\[1\].palette.name cold_hot --field\[1\].contour.on
...
test_fill: 
	$(RUNTEST) --landscape.on --field\[0\].path testdata/t1198c2.2/N.grb --field\[0\].scale 1.03 --field[0].palette.name RGBW   --colorbar.on --window.width 1200

test_dashed1:
	$(RUNTEST) --landscape.on --landscape.orography 0 --landscape.wireframe.on --landscape.geometry testdata/contour/t0479.grb --window.width 1024 --window.height 1024 \
...
test_travelling:
	$(RUNTEST) --scene.travelling.on --scene.travelling.pos1.lon 0 --scene.travelling.pos1.lat 0 --scene.travelling.pos1.fov 30 \
...
test_strxyz:
	$(RUNTEST) --field\[0\].path testdata/t1198c2.2/N.grb --field\[0\].scale 0.99 \
		--colorbar.on --colorbar.font.color.foreground green --window.width 1000 --view.projection XYZ --scene.test_strxyz.on

test_interpolation:
	$(RUNTEST) --field\[0\].path testdata/interp/01.grb testdata/interp/36.grb  --field\[0\].scale 1.03 --field\[0\].palette.name cold_hot_temp  \
...
test_fa:
	$(RUNTEST) --field\[0\].path testdata/fa/PGD.t479.fa%SFX.FRAC_SEA  --field\[0\].scale 1.03 

test_select_grib:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --field\[0\].path testdata/t1198c2.2/N.grb%'parameterCategory=6,year=2019' --field\[0\].scale 1.03 

test_scalar_diff:
	$(RUNTEST) --field[0].diff.on --field\[0\].path testdata/interp/01.grb testdata/interp/36.grb --field\[0\].scale 1.01  --view.lon 2 --view.lat 46.7 --view.fov 5 

test_contour_diff:
	$(RUNTEST) --field[0].diff.on --field[0].contour.on --field\[0\].path testdata/glob01/lfpw_0_3_1_sfc_0_prmsl+0000.grib2 testdata/glob01/lfpw_0_3_1_sfc_0_prmsl+0102.grib2 \
		--field\[0\].scale 1.01  
...
test_shell:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --field\[0\].path testdata/t1198c2.2/N.grb --field\[0\].scale 1.03 --shell.on 

test_mapscale:
	$(RUNTEST) --landscape.on --mapscale.on

test_shell_batch:
	$(RUNTEST) testdata/glgrib.in

test_cities:
	$(RUNTEST) --landscape.on --cities.on --cities.points.scale 1.01 --cities.points.size.value  1  --cities.points.size.variable.on  \
		--view.lat 46.7 --view.lon 2 --view.fov 2 --cities.points.size.value 2 --cities.labels.on --cities.labels.font.color.foreground red --cities.labels.font.scale 0.04
...
test_title:
	$(RUNTEST) --landscape.on --landscape.geometry testdata/t1198c2.2/Z.grb --field\[0\].path testdata/t1198c2.2/N.grb --field\[0\].scale 1.03 --scene.title.on

test_departements:
	$(RUNTEST) --departements.on --departements.lines.color blue --departements.lines.hash 'code_insee' 23 'code_insee' 19 code_insee 87 --view.lon 2 --view.lat 46.7 --view.fov 5 --coast.on
