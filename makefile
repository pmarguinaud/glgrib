...
LDFLAGS=-fopenmp -leccodes -lGLEW -lGL -lEGL -lglfw -lpng -lreadline -ltinfo -lssl -lcrypto

#CXXFLAGS=-fopenmp -std=c++11 -g -I$(HOME)/install/eccodes-2.12.0/include -I$(HOME)/3d/glgrib/usr/include -L$(HOME)/3d/glgrib/usr/lib64 -Wl,-rpath,$(HOME)/3d/glgrib/usr/lib64 -L$(HOME)/install/eccodes-2.12.0/lib -Wl,-rpath,$(HOME)/install/eccodes-2.12.0/lib -leccodes -lGLEW -lGL -lEGL -lglfw -lpng -lreadline -lncurses -ltinfo -lssl -lcrypto
