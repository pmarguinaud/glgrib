...
test_landscape_eurat01: ./glgrib.x
	$(GDB) ./glgrib.x --landscape.on --landscape.geometry  testdata/eurat01/lfpw_0_0_0_pl_1000_t.grib2 --landscape.orography 0 --coastlines.on --grid.on

test_glob01: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].path testdata/glob01/lfpw_0_0_0_sfc_0_t.grib2 --field[0].scale 1.00  --field[0].palette cold_hot_temp --coastlines.on --grid.on
...
test_missingvalue: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].path testdata/t49/SFX.CLAY.grb --coastlines.on --grid.on

test_aro: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].path testdata/aro2.5/SURFIND.TERREMER.grb --field[0].palette cold_hot --field[0].scale 1.00 --camera.lat 46.2 --camera.lon 2.0 --camera.fov 5 --coastlines.on --grid.on

test_guyane: ./glgrib.x
	$(GDB) ./glgrib.x --landscape.on --field\[0\].path testdata/aro_guyane/SURFTEMPERATURE.grb --field\[0\].palette cold_hot_temp --field\[0\].scale 1.01 --camera.lat 5 --camera.lon -51 --camera.fov 3 --coastlines.on --grid.on

test_vector: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].vector.on --field\[0\].path testdata/aro2.5/S090WIND.U.PHYS.grb  testdata/aro2.5/S090WIND.V.PHYS.grb --field\[0\].scale 1.00 --field\[0\].vector.color green --camera.lat 46.2 --camera.lon 2.0 --camera.fov 5  --coastlines.on --grid.on

test_small_aro: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].vector.on --field\[0\].path testdata/aro_small/S041WIND.U.PHYS.grb testdata/aro_small/S041WIND.V.PHYS.grb  --field\[0\].scale 1.00 --camera.lon 26.64 --camera.lat 67.36 --camera.fov 0.5 --coastlines.on --grid.on
...
test_contour2: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/t0479.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour3: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/t1798.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_stretched: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --field\[0\].path testdata/t1198c2.2/Z.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon1: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/latlon9x6.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon2: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/contour/latlon18x13.grb --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon3: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --landscape.on --landscape.path landscape/black.bmp  --field\[0\].path testdata/eurat01/lfpw_0_0_0_pl_1000_t.grib2 --field\[0\].scale 1.03 --field\[0\].contour.on

test_contour_latlon4: ./glgrib.x
	$(GDB) ./glgrib.x --window.width 1024 --window.height 1024 --field\[0\].path testdata/glob025/lfpw_0_0_0_pl_1000_t.grib2 --field\[1\].path testdata/glob025/lfpw_0_0_0_pl_1000_t.grib2 --field\[1\].palette cold_hot --field\[1\].contour.on
...
test_contour_aro1: ./glgrib.x
	$(GDB) ./glgrib.x \
               ...
               --camera.lon 26.64 --camera.lat 67.36 --camera.fov 0.5 --coastlines.on --grid.on
...
test_contour_aro2: ./glgrib.x
	$(GDB) ./glgrib.x \
               ...
               --camera.lat 46.2 --camera.lon 2.0 --camera.fov 5 --coastlines.on --grid.on

test_fill: ./glgrib.x
	$(GDB) ./glgrib.x --landscape.on --field\[0\].path testdata/t1198c2.2/N.grb --field\[0\].scale 1.03 --field[0].palette RGBW   --colorbar.on --window.width 1200

test_dashed1: ./glgrib.x
	$(GDB) ./glgrib.x --landscape.on --landscape.orography 0 --landscape.wireframe --landscape.geometry testdata/contour/t0479.grb --window.width 1024 --window.height 1024 --field\[0\].path testdata/contour/t0479.grb --field\[0\].scale 1.00 --field\[0\].contour.on --field[0].contour.lengths 100  --field[0].contour.patterns X- --camera.fov 5
...
test_scalar_diff: ./glgrib.x
	$(GDB) ./glgrib.x --field[0].diff --field\[0\].path testdata/interp/01.grb testdata/interp/36.grb --field\[0\].scale 1.01  --camera.lon 2 --camera.lat 46.7 --camera.fov 5 
