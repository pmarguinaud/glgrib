...
test_cities: ./glgrib.x
	$(RUNTEST) ./glgrib.x --landscape.on --cities.on --cities.points.scale 1.01 --cities.points.size.value  1  --cities.points.size.variable.on  \
...
test_optionsfile: ./glgrib.x
	$(RUNTEST) ./glgrib.x --{testdata/options.list}
