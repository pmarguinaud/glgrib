...
test_interpolation: ./glgrib.x
	$(GDB) ./glgrib.x --field\[0\].path testdata/interp/1.grb testdata/interp/6.grb  --field\[0\].scale 1.03 --field\[0\].palette cold_hot_temp  \
