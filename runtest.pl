...
(
  ...
  "Display vector norm, global lat/lon geometry                     " ,  vector_glob25       => '--landscape.on --landscape.geometry testdata/arpt1798_wind/lfpw_0_2_2_sfc_20_u.grib2 --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/glob25_+1.grb testdata/arpt1798_wind/glob25_+1.grb --field[0].scale 1.01 --coast.on --grid.on',
  "Vector arrow, stretched/rotated gaussian geometry                " ,  vector_t1798        => '--landscape.on --landscape.geometry testdata/arpt1798_wind/+1.grb --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/+1.grb testdata/arpt1798_wind/+1.grb --field[0].scale 1.01 --coast.on --grid.on',
  ...
  "Display wind on stretched/rotated gaussian geometry              " ,  wind_arp            => '--landscape.on --landscape.geometry testdata/t31c2.4/Z.grb --field[0].type VECTOR --field[0].path testdata/t31c2.4/S015WIND.U.PHYS.grb testdata/t31c2.4/S015WIND.V.PHYS.grb --field[0].scale 1.01 --coast.on --grid.on',
  "Wind on global lat/lon geometry                                  " ,  wind_glob25         => '--landscape.on --landscape.geometry testdata/arpt1798_wind/lfpw_0_2_2_sfc_20_u.grib2 --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/lfpw_0_2_2_sfc_20_u.grib2 testdata/arpt1798_wind/lfpw_0_2_3_sfc_20_v.grib2 --field[0].scale 1.01 --coast.on --grid.on',
  "Wind on stretched/rotated gaussian geometry                      " ,  wind_t1798          => '--landscape.on --landscape.geometry testdata/arpt1798_wind/S105WIND.U.PHYS.grb --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/S105WIND.U.PHYS.grb testdata/arpt1798_wind/S105WIND.V.PHYS.grb --field[0].scale 1.01 --coast.on --grid.on',
