...
(
  ...
  "Landscape over Europe only                                       " ,  landscape_eurat01   => '--landscape.on --landscape.geometry_path testdata/eurat01/lfpw_0_0_0_pl_1000_t.grib2 --landscape.orography 0 --coast.on --grid.on',
  ...
  "Low-res ARPEGE resolution                                        " ,  small               => '--landscape.on --landscape.geometry_path testdata/t49/Z.grb --field[0].scale 1.01 --field[0].path testdata/t49/SFX.CLAY.grb --coast.on --grid.on',
  ...
  "Display vector norm & arrow, Lambert geometry                    " ,  vector              => '--field[0].type VECTOR --field[0].path testdata/aro2.5/S090WIND.U.PHYS.grb testdata/aro2.5/S090WIND.V.PHYS.grb --field[0].scale 1.00 --field[0].vector.color green --view.lat 46.2 --view.lon 2.0 --view.fov 5 --coast.on --grid.on',
  "Display vector norm, global lat/lon geometry                     " ,  vector_glob25       => '--landscape.on --landscape.geometry_path testdata/arpt1798_wind/lfpw_0_2_2_sfc_20_u.grib2 --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/glob25_+1.grb testdata/arpt1798_wind/glob25_+1.grb --field[0].scale 1.01 --coast.on --grid.on',
  "Vector arrow, stretched/rotated gaussian geometry                " ,  vector_t1798        => '--landscape.on --landscape.geometry_path testdata/arpt1798_wind/+1.grb --landscape.orography 0 --field[0].type VECTOR --field[0].path testdata/arpt1798_wind/+1.grb testdata/arpt1798_wind/+1.grb --field[0].scale 1.01 --coast.on --grid.on',
  ...
  "Landscape with orography (T479)                                  " ,  land_orography      => '--landscape.on --landscape.geometry_path ./testdata/t479/Z.grb  --landscape.orography 0.2 --landscape.flat.off',
