...
./glgrib.x --test.on --test.selector "rowid == 4"  --coast.on --coast.lines.format shp  --coast.lines.path coastlines/shp/GSHHS_c_L1.shp --coast.lines.selector "rowid == 3" > shp1.eo 2>&1
