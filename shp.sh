...
gdb -ex="set confirm on" -ex=run -ex=quit --args ./glgrib.x --land.on  --land.path coastlines/shp/GSHHS_c_L1.shp --land.selector "rowid <= 46" \
	    --coast.on --coast.lines.path coastlines/shp/GSHHS_c_L1.shp --coast.lines.format shp --view.lon -159 --view.lat 47 --view.fov 3
